...
class Item {
  ...
  factory Item(String name, {String location, bool active: true}) => _items
      .firstWhere((Item i) =>
              i.name == name && i.location == location && i.active == active,
          orElse: () {
  ...
  static Set<Item> getAllIn(String location, {bool onlyActive: true}) => _items
      .where((Item i) => (i.location == location) &&
          ((onlyActive && i.active) || (!onlyActive)))
      .toSet();

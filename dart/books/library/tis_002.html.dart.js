...
$$.HashMapImplementation = {"":
 ...
 _grow$1: function(newCapacity) {
  ...
  $.assertHelper($.eq($.and(newCapacity, $.sub(newCapacity, 1)), 0));
...
$$.LinkedHashMapImplementation = {"":
 ...
 getKeys$0: function() {
  ...
  $.assertHelper($.eq(t1.index_1, $.get$length(this)));
  return list;
},
 getValues$0: function() {
  var t1 = {};
  ...
  $.assertHelper($.eq(t1.index_10, $.get$length(this)));
  return list;
},
 forEach$1: function(f) {
  $.functionTypeCheck(f);
 ...
 LinkedHashMapImplementation$0: function() {
  ...
  this._map = $.propertyTypeCheck($.HashMapImplementation$(t1, 'DoubleLinkedQueueEntry<KeyValuePair<' + t2.K +', ' + t2.V +'>>'), 'is$HashMap');
  t1 = $.getRuntimeTypeInfo(this);
  this._list = $.propertyTypeCheck($.DoubleLinkedQueue$('KeyValuePair<' + t1.K +', ' + t1.V +'>'), 'is$DoubleLinkedQueue');
},
 is$HashMap: true,
 is$Map: function() { return true; }
};
...
$$.Object = {"":
 ...
 get$currentPageIndex: function() {
  return this.noSuchMethod$2("get:currentPageIndex", []);
 },
 get$_id: function() {
...
$$._Copier = {"":
 ...
 visitList$1$bailout: function(state0, list, len) {
...
$$._Serializer = {"":
 ...
 _serializeList$1$bailout: function(state0, list, len) {
  var result = $.ListImplementation_List(len);
  for (var i = 0; $.boolConversionCheck($.lt(i, len)); i = $.intTypeCheck($.add(i, 1))) {
    var t1 = this._dispatch$1($.index(list, i));
    if (i !== (i | 0))
...
$$._Deserializer = {"":
 ...
 _deserializeList$1$bailout: function(state0, len, dartList) {
  for (var i = 0; $.boolConversionCheck($.lt(i, len)); i = $.intTypeCheck($.add(i, 1)))
    $.indexSet(dartList, i, this._deserializeHelper$1($.index(dartList, i)));
  return dartList;
},
 _deserializeMap$1: function(x) {
  ...
  $.assertHelper(len === $.get$length(values));
  for (var i = 0; $.boolConversionCheck($.lt(i, len)); i = $.intTypeCheck($.add(i, 1)))
    result.operator$indexSet$2(this._deserializeHelper$1($.index(keys, i)), this._deserializeHelper$1($.index(values, i)));
  return result;
},
 _deserializeMap$1$bailout: function(state0, keys, values, result, len) {
  var t2 = $.get$length(values);
  $.assertHelper(len == null ? t2 == null : len === t2);
  for (var i = 0; $.boolConversionCheck($.lt(i, len)); i = $.intTypeCheck($.add(i, 1)))
    result.operator$indexSet$2(this._deserializeHelper$1($.index(keys, i)), this._deserializeHelper$1($.index(values, i)));
  return result;
},
...
$$.Storyline = {"":
 ...
 string$1$bailout: function(state0, i, t1) {
  if ($.boolConversionCheck(t1 || $.boolConversionCheck($.ge(i, this.reports.length))))
    return;
  else {
    t1 = this.reports;
 ...
 timeSincePrevious$1$bailout: function(state0, env0, env1) {
  switch (state0) {
    case 1:
      var i = env0;
      t2 = env1;
  ...
  switch (state0) {
    case 0:
      ...
      if (!($.index(t1[i], 'time') == null)) {
        ...
        t1 = true;
    default:
      if (state0 === 0 && $.boolConversionCheck(t1))
        return $.Storyline_VERY_LONG_TIME;
      else
        switch (state0) {
          case 0:
 ...
 same$3$bailout: function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      var key = env0;
      var i = env1;
  ...
  switch (state0) {
    case 0:
      $.intTypeCheck(j);
    case 1:
      if (state0 === 1 || state0 === 0 && $.boolConversionCheck(this.valid$1(i)))
        switch (state0) {
          case 0:
            var t1 = this.valid$1(j);
            $.boolConversionCheck(t1);
 ...
 exchanged$4$bailout: function(state0, env0, env1, env2, env3, env4) {
  switch (state0) {
    case 1:
      var key1 = env0;
      var key2 = env1;
 ...
 sameSentiment$2$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      var i = env0;
      var j = env1;
 ...
 oppositeSentiment$2$bailout: function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      var i = env0;
      var j = env1;
 ...
 substitute$4$bailout: function(state0, i, str, useSubjectPronoun, useObjectPronoun) {
  var result = $.stringTypeCheck($.replaceAll(str, '<action>', this.string$1(i)));
...
$$.Actor = {"":
 ...
 get$modifiedDodging$bailout: function(state0, value) {
  for (var t1 = $.iterator(this.armors); $.boolConversionCheck(t1.hasNext$0());)
    value = $.intTypeCheck($.add(value, t1.next$0().get$dodgingMod()));
  return value;
},
 ...
 getPossibleMoves$1: function(max) {
  ...
  for (var regularIndex = 0, i = 0; $.boolConversionCheck($.lt(i, possibleMoves.length)); i = $.intTypeCheck($.add(i, 1))) {
    ...
    if (t1) {
      ...
      if (regularIndex < 0 || regularIndex >= t2)
      ...
      if (redundantIndex < 0 || redundantIndex >= t2)
 ...
 chooseMove$1$bailout: function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      random = env0;
      possibleMoves = env1;
...
$$.CombatMoveType = {"":
 ...
 hasFlag$1$bailout: function(state0, otherFlags, t1) {
  return (t1 & otherFlags) >>> 0 !== 0;
},
 get$isOffensive: function() {
...
$$.CombatEvent = {"":
 ...
 CombatEvent$fromMove$1: function(currentMove) {
  ...
  $.assertHelper($.eq(this.performer.get$combat(), this.target.get$combat()));
...
$$.Combat = {"":
 ...
 update$0$bailout: function(state0, env0, env1) {
  ...
  switch (state0) {
    ...
    case 3:
      if (state0 === 3 || state0 === 0 && timePassed)
        switch (state0) {
          case 0:
            $.index(this.on, 'update').dispatchAll$0();
            $.forEach(this.actors, new $.Combat_update_anon());
      ...
      t1 = this._player;
    case 4:
      if (state0 === 4 || state0 === 0 && !(t1 == null))
        switch (state0) {
          case 0:
          case 4:
            if (state0 === 4 || state0 === 0 && $.boolConversionCheck(t1.get$alive()))
              switch (state0) {
                case 0:
        ...
        t1 = false;
    default:
      if (state0 === 7 || state0 === 6 || state0 === 5 || state0 === 0 && $.boolConversionCheck(t1))
        switch (state0) {
          case 0:
          default:
            if (state0 === 5 || state0 === 0 && this._player.get$target() == null)
              switch (state0) {
                case 0:
                  var possibleEnemies = $.filter(this.actors, new $.Combat_update_anon1(this));
                  $.listTypeCheck(possibleEnemies);
...
$$.ScripterImpl = {"":
 ["_interfacePort", "pages", "pageHandles", "blocks", "currentPageIndex", "currentBlock", "nextPageIndex", "repeatBlockBit", "nextScriptStack", "choices", "vars", "textBuffer"],
 "super": "Scripter",
...
$$.Scripter = {"":
 ["pageHandles?", "currentPageIndex?", "nextPageIndex"],
 "super": "Object",
 set$nextPageIndex: function(v) { this.nextPageIndex = $.intTypeCheck(v); },
 get$currentPageName: function() {
  if (this.currentPageIndex == null)
    return;
  $.forEach(this.pageHandles, new $.Scripter_currentPageName_anon(this));
},
 ...
 goto$1: function(dest) {
  ...
  if ($.boolConversionCheck(this.pageHandles.containsKey$1($.S(this.get$currentPageName()) + ': ' + $.S(dest))))
    this.nextPageIndex = $.intTypeCheck($.index(this.pageHandles, $.S(this.get$currentPageName()) + ': ' + $.S(dest)));
  else if ($.boolConversionCheck(this.pageHandles.containsKey$1(dest)))
    this.nextPageIndex = $.intTypeCheck($.index(this.pageHandles, dest));
  else
...
$$._ChildrenElementList = {"":
 ...
 _toList$0$bailout: function(state0, len, output, t1) {
  var i = 0;
  for (; $.boolConversionCheck($.lt(i, len)); i = $.intTypeCheck($.add(i, 1))) {
    var t2 = t1.operator$index$1(i);
    if (i !== (i | 0))
...
$$._convertDartToNative_PrepareForStructuredClone_findSlot = {"":
 ...
 call$1$bailout: function(state0, value, t1, length$) {
  for (var i = 0; $.boolConversionCheck($.lt(i, length$)); i = $.intTypeCheck($.add(i, 1))) {
    var t2 = $.index(t1, i);
    if (t2 == null ? value == null : t2 === value)
      return i;
...
$$._convertDartToNative_PrepareForStructuredClone_walk = {"":
 ...
 call$1$bailout: function(state0, env0, env1, env2, env3) {
  ...
  switch (state0) {
    ...
    default:
      if (state0 === 2 || state0 === 1 || state0 === 0 && typeof e === 'object' && e !== null && (e.constructor === Array || e.is$List()))
        switch (state0) {
          case 0:
            var length$ = $.get$length(e);
            $.intTypeCheck(length$);
...
$$.anon1 = {"":
 ...
 "super": "Closure",
 call$0: function() {
  $.assertHelper($.countBits(15) === 4);
  $.assertHelper($.countBits(255) === 8);
  $.assertHelper($.countBits(65535) === 16);
  $.assertHelper($.countBits(65534) === 15);
  $.assertHelper($.countBits(65534) === 15);
  $.assertHelper($.capitalize('things') === 'Things');
  $.assertHelper($.capitalize('/things') === '/things');
}
};
...
$$.anon2 = {"":
 ...
 call$0: function() {
  ...
  $.print(result);
  $.assertHelper(result === 'you hit him in the face' || result === 'you punch him in the face');
  result = $.stringTypeCheck($.Storyline_resolveRandoms('{you|thy} have my word, {Sir|Sire}'));
  $.print(result);
  $.assertHelper($.boolConversionCheck($.startsWith(result, 'you have')) || $.boolConversionCheck($.startsWith(result, 'thy have')));
  $.assertHelper($.boolConversionCheck($.endsWith(result, ', Sir')) || $.boolConversionCheck($.endsWith(result, ', Sire')));
  result = $.stringTypeCheck($.Storyline_resolveRandoms('{||blank }options'));
  $.print(result);
  $.assertHelper(result === 'options' || result === 'blank options');
  result = $.stringTypeCheck($.Storyline_resolveRandoms('{||blank }options'));
  $.print(result);
  $.assertHelper(result === 'options' || result === 'blank options');
  result = $.stringTypeCheck($.Storyline_resolveRandoms('{1|two|3} options'));
  $.print(result);
  $.assertHelper(result === '1 options' || result === 'two options' || result === '3 options');
  result = $.stringTypeCheck($.Storyline_resolveRandoms('{1|two|3} options'));
  $.print(result);
  $.assertHelper(result === '1 options' || result === 'two options' || result === '3 options');
  result = $.stringTypeCheck($.Storyline_resolveRandoms('{I am deeply {honoured|humbled}|You {honour|humble} me, Sire}.'));
  $.print(result);
  $.assertHelper($.boolConversionCheck($.startsWith(result, 'I am')) || $.boolConversionCheck($.startsWith(result, 'You ')));
  $.assertHelper($.boolConversionCheck($.endsWith(result, 'ed.')) || $.boolConversionCheck($.endsWith(result, 'Sire.')));
  result = $.stringTypeCheck($.Storyline_resolveRandoms('No tags.'));
  $.print(result);
  $.assertHelper(result === 'No tags.');
  var result0 = $.stringTypeCheck($.Storyline_resolveRandoms('This is {not an option string}.'));
  $.print(result0);
  $.assertHelper(result0 === 'This is {not an option string}.');
  var result1 = $.stringTypeCheck($.Storyline_resolveRandoms('{}malformed {} horrible string{}'));
  $.print(result1);
  $.assertHelper(result1 === '{}malformed {} horrible string{}');
  var result2 = $.stringTypeCheck($.Storyline_resolveRandoms('{unbalanced{g|er|e}'));
  $.print(result2);
  $.assertHelper(result2 === '{unbalanced{g|er|e}');
  ...
  $.assertHelper($.lt(countBelow, 500));
  $.assertHelper($.lt(countBelow, 200));
  var a = $.Actor$();
  var b = $.Actor$();
  b.set$stance(19);
  var t1 = this.this_2;
  $.assertHelper($.eq(t1.get$v_moveKickLegs().canContinue$2(a, b), false));
  $.assertHelper($.eq(t1.get$v_moveKickLegs().isApplicable$2(a, b), false));
}
};
...
$$.anon3 = {"":
 ...
 call$0: function() {
  ...
  $.assertHelper($.gt(t1.get$v_teamOneWins(), t1.get$v_teamTwoWins()));
}
};
...
$$.anon7 = {"":
 ...
 call$0: function() {
  ...
  $.assertHelper(t2.get$v_combat().get$finished());
  ...
  switch (state0) {
    case 0:
      ...
      if (e instanceof RegExp)
        throw $.$$throw($.CTC3);
    case 1:
      if (state0 === 1 || state0 === 0 && $._isJavaScriptSimpleObject(e))
        switch (state0) {
          case 0:
            var slot = this.findSlot_5.call$1(e);
            var copy = this.readSlot_4.call$1(slot);
...
$$.Scripter_currentPageName_anon = {"":
 ["this_0"],
 "super": "Closure",
 call$2: function(k, v) {
  $.stringTypeCheck(k);
  $.intTypeCheck(v);
  var t1 = this.this_0.get$currentPageIndex();
  if (v == null ? t1 == null : v === t1)
    return k;
}
};
...
$.DualPivotQuicksort__dualPivotQuicksort = function(a, left, right, compare) {
  ...
  $.functionTypeCheck(compare);
  $.assertHelper($.gt($.sub(right, left), 32));
...
$._IsolateNatives__processWorkerMessage = function(sender, e) {
  ...
  switch ($.index(msg, 'command')) {
    case 'start':
      ...
      var entryPoint = $.functionTypeCheck($._IsolateNatives__getJSFunctionFromName($.index(msg, 'functionName')));
...
$._IsolateNatives__getJSFunctionName = function(f) {
  return ($.functionTypeCheck(f).$name || null);
};
  ...
  if (startTagIndex !== -1 && startTagIndex < str.length - 1) {
    ...
    while (true) {
      if (lastIndex !== (lastIndex | 0))
        return $.Storyline_resolveRandoms$bailout(4, str, indexes, lastIndex, startTagIndex, depth, i, 0);
      ...
      if (ch === '{') {
        ...
        $.intTypeCheck(depth);
        if (depth !== (depth | 0))
          return $.Storyline_resolveRandoms$bailout(5, str, depth, indexes, startTagIndex, i, 0, 0);
      } else if (ch === '|' && depth === 1)
        indexes.push(i);
      else if (ch === '}') {
        depth = $.sub(depth, 1);
    ...
    if (numOptions > 1) {
      ...
      if (typeof t5 !== 'number')
        return $.Storyline_resolveRandoms$bailout(10, strBuf, str, indexes, lastIndex, endTagIndex, t5, choice);
      ++t5;
      var t7 = choice + 1;
      if (t7 >= t4)
        throw $.ioore(t7);
...
$.ScripterImpl$ = function() {
  ...
  t3 = new $.ScripterImpl(null, null, t1, t2, t3, t3, t3, false, $.listTypeCheck(null), $.listTypeCheck(null), $.callTypeCheck(null, 'is$Map'), $.propertyTypeCheck(null, 'is$StringBuffer'));
  t3.Scripter$0();
  t3.ScripterImpl$0();
  return t3;
};
...
$._IsolateNatives__getJSFunctionFromName = function(functionName) {
  return $globalThis[$.stringTypeCheck(functionName)];
};
...
$.Arrays_lastIndexOf$bailout = function(state0, env0, env1, env2) {
  switch (state0) {
    case 1:
      var a = env0;
      var element = env1;
...
$.Arrays_indexOf$bailout = function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      var a = env0;
      var element = env1;
...
$._Lists_getRange$bailout = function(state0, env0, env1, env2, env3) {
  switch (state0) {
    case 1:
      var a = env0;
      var start = env1;
...
$.Storyline_resolveRandoms$bailout = function(state0, env0, env1, env2, env3, env4, env5, env6) {
  switch (state0) {
    case 1:
      var str = env0;
      break;
  ...
  switch (state0) {
    ...
    case 2:
      state0 = 0;
    default:
      if (state0 === 10 || state0 === 9 || state0 === 8 || state0 === 7 || state0 === 6 || state0 === 5 || state0 === 4 || state0 === 3 || state0 === 0 && $.boolConversionCheck(!(startTagIndex === -1) && $.boolConversionCheck($.lt(startTagIndex, $.sub($.get$length(str), 1)))))
        switch (state0) {
          case 0:
            var indexes = $.ListImplementation_List(null, 'int');
            $.setRuntimeTypeInfo(indexes, {'E': 'int'});
                  ...
                  default:
                    if (state0 === 5 || state0 === 0 && ch === '{')
                      ...
                      switch (state0) {
                        case 0:
                        case 6:
                          if (state0 === 0 && $.boolConversionCheck(ch === '|' && depth === 1))
                            indexes.push(i);
                          else
                            switch (state0) {
                              case 0:
                              case 6:
                                if (state0 === 6 || state0 === 0 && ch === '}')
                                  switch (state0) {
                                    case 0:
                                      depth = $.sub(depth, 1);
                                      $.intTypeCheck(depth);
          ...
          case 9:
          case 10:
            if (state0 === 10 || state0 === 9 || state0 === 0 && $.boolConversionCheck(numOptions > 1))
              switch (state0) {
                case 0:
...
$.DualPivotQuicksort__dualPivotQuicksort$bailout = function(state0, env0, env1, env2, env3, env4, env5, env6, env7, env8, env9) {
  switch (state0) {
    case 1:
      var a = env0;
      var left = env1;
...
$.countBits$bailout = function(state0, x) {
  for (var count = 0; $.boolConversionCheck($.gt(x, 0)); count = $.intTypeCheck($.add(count, 1)))
    x = $.intTypeCheck($.and(x, $.sub(x, 1)));
  return count;
};
...
$.DualPivotQuicksort_insertionSort_$bailout = function(state0, env0, env1, env2, env3, env4) {
  switch (state0) {
    case 1:
      var a = env0;
      var left = env1;
...
(function(table) {
 ...
 is$LocalLocation: function() { return false; },
...
$.$defineNativeClass('Location', [], {
 ...
 is$LocalLocation: function() { return true; }
});

...
class BodegaZil {
  ...
  void setupGorillasDen() {
    gorillasDen = new Room(zil, "Explore: GorillasDen", "cargo bay", [new Exit(
        "Explore: CargoBayLeft", "go back to entrance to Corridor Left",
        "you arrive at the entrance to Corridor Left")], descriptionPage:
        "GorillasDen.description", coordinates: [-10, -70, 0]);
  }

  Room gorillasDen;

  void setupPlaceOfBreach() {
    new Room(zil, "Explore: PlaceOfBreach", "cargo bay", [new Exit(
        "Explore: CargoBayRight", "go back to entrance to Corridor Right",
        "you arrive at the entrance to Corridor Right")], descriptionPage:
        "PlaceOfBreach.description", coordinates: [10, -70, 0]);
  }
  ...
  void setupCargoBayRight() {
    ...
    // ROOM
    new Room(zil, "Explore: CargoBayRight", "cargo bay", [new Exit(
        "Explore: CorridorRightJunction", "enter Corridor Right",
        ...
        "console, located at the front center of the bay", cost: 2), exitToHullBreach],
  ...
  void setupCargoCenter() {
    new Room(zil, "Explore: CargoCenter", "cargo bay", [new Exit(
        "Explore: CargoBayLeft", "go to the left side of the cargo bay",
        "<subject> arrive<s> at the left side of the cargo bay", cost: 2), new Exit(
        "Explore: CargoBayRight", "go to the right side of the " "cargo bay",
        "<subject> arrive<s> at the right side of the cargo bay", cost: 2)],
        descriptionPage: "CargoCenter.description", coordinates: [0, -55, 0], actions:
        [new Action.Goto("approach the console", "CargoCenter.console", onlyOnce: false
        )]);
  }

  void setupExplodedContainer() {
    new Room(zil, "Explore: ExplodedContainer", "cargo bay", [new Exit(
        "Explore: CargoBayLeft", "go to the Corridor Left entrance",
        "<subject> arrive<s> at the front left side of the cargo bay", cost: 2)],
        descriptionPage: "ExplodedContainer.description", coordinates: [-10, -100, -10],
        actions: [new Action.Goto("Search [~30 minutes]", "ExplodedContainer.search",
        onlyOnce: true)]);
  }
  ...
  void setupCargoBayLeft() {
    ...
    cargoBayLeft = new Room(zil, "Explore: CargoBayLeft", "cargo bay",
        ...
        new Exit("Explore: CargoCenter", "go to the other side of the cargo bay",
        "after a few moments, <subject> arrive<s> at the cargo bay "
        "console, located at the front center of the bay", cost: 2), new Exit(
        "Explore: ExplodedContainer", "go to the place of the explosion",
        "you head deep into the cargo bay and after about 2 minutes, "
        "you arrive at the site of the explosion", cost: 2)], descriptionPage:
        "CargoBayLeft.description", coordinates: [-10, -55, 0]);
  }

  Room cargoBayLeft;

  void setupCorridorRightJunction() {
    new Room(zil, "Explore: CorridorRightJunction", "right junction", [new Exit(
        "Explore: CorridorRightNextToBunks", "walk towards the bridge",
        "after quite a walk, <subject> arrive<s> to the entrance to the " "bunks"),
        new Exit("Explore: Guts", "enter the guts",
        "<subject> open<s> the door and step<s> through a narrow hatchway"), new Exit(
        "Explore: EngineRoom", "enter the engine room",
        ...
        "the cargo bay through a huge {entrance|door}")], descriptionPage:
        "CorridorRightJunction.description", coordinates: [5, -45, 0]);
  }
  ...
  void setupCorridorRightNextToBunks() {
    new Room(zil, "Explore: CorridorRightNextToBunks", "Corridor Right",
        ...
        "<subject> walk<s> towards the front of the ship"), new Exit("Explore: Bunks",
        "enter the bunks", "<subject> enter<s> the bunks"), new Exit(
        ...
        cost: 2)], descriptionPage: "CorridorRightNextToBunks.description", coordinates:
        [5, -25, 0]);
  }
  ...
  void setupMedicalBay() {
    ...
    // ROOM
    new Room(zil, "Explore: MedicalBay", "medical bay", [new Exit(
        "Explore: StaffRoom", "use the little door",
  ...
  void setupCorridorRightNextToAirlock() {
    ...
    pullLever = new Action.Goto("pull the lever to let the captain's body out",
        "CorridorRightNextToAirlock.PullLever", onlyOnce: true, isActive: false);

    // ROOM
    new Room(zil, "Explore: CorridorRightNextToAirlock", "Corridor Right",
        [new Exit("Explore: CorridorRightNextToComputerRoom", "walk towards the bridge",
        "<subject> arrive<s> at the door to the computer room"), new Exit(
        "Explore: MedicalBay", "enter the medical bay",
        "<subject> enter<s> the medical bay"), new Exit(
        "Explore: CorridorRightNextToBunks",
        "walk {toward the cargo bay|to the {aft|back} of the ship}",
        "<subject> {stride|walk}<s> towards the {{aft|back} of the " "ship|cargo bay}"
        )], descriptionPage: "CorridorRightNextToAirlock.description", coordinates: [10,
        -15, 0], actions: [new Action.Goto("look into the airlock",
        "CorridorRightNextToAirlock.Look", onlyOnce: true), pullLever]);
  }
  ...
  void setupComputerRoom() {
    ...
    new Room(zil, "Explore: ComputerRoom", "Computer Room", [new Exit(
        "Explore: CorridorRightNextToComputerRoom", "leave",
        "<subject> {walk|step}<s> out to Corridor Right")], descriptionPage:
        "ComputerRoom.description", coordinates: [7, -10, 0]);
  }
  ...
  void setupCorridorRightNextToComputerRoom() {
    new Room(zil, "Explore: CorridorRightNextToComputerRoom", "Corridor Right",
        ...
        "<subject> {enter<s>|arrive<s> at} the bridge"), new Exit(
        "Explore: ComputerRoom", "enter the Computer Room",
        "<subject> {walk|step}<s> through the door"), new Exit(
        "Explore: CorridorRightNextToAirlock",
        "walk {toward the cargo bay|to the {aft|back} of the ship}",
        "<subject> {stride|walk}<s> towards the {{aft|back} of the ship|cargo bay}")],
        descriptionPage: "CorridorRightNextToComputerRoom.description", coordinates: [5,
        -10, 0]);
  }
  ...
  void setupEngineRoom() {
    ...
    // ROOM
    new Room(zil, "Explore: EngineRoom", "engine room", [new Exit(
        "Explore: CorridorLeftJunction", "exit to Corridor Left",
        "<subject> {{exit|leave}<s>|step<s> out} to Corridor Left"), new Exit(
        "Explore: CorridorRightJunction", "exit to Corridor Right",
        "<subject> {{exit|leave}<s>|step<s> out} to Corridor Right")], descriptionPage:
        "EngineRoom.description", coordinates: [0, -50, 0], actions:
        [repairEngineAction]);
  }
  ...
  void setupGuts() {
    ...
    // ROOM
    new Room(zil, "Explore: Guts", "guts", [new Exit(
        "Explore: CorridorLeftJunction", "exit to Corridor Left",
        "<subject> {{exit|leave}<s>|step<s> out} to Corridor Left"), new Exit(
        "Explore: CorridorRightJunction", "exit to Corridor Right",
        "<subject> {{exit|leave}<s>|step<s> out} to Corridor Right")], descriptionPage:
        "Guts.description", coordinates: [0, -45, 0], actions: [lookAtTurret,
        repairTurret]);
  }
  ...
  void setupCorridorLeftJunction() {
    new Room(zil, "Explore: CorridorLeftJunction", "left junction", [new Exit(
        "Explore: CorridorLeftNextToBunks", "walk towards the bridge",
        "after quite a walk, <subject> arrive<s> to the entrance to the " "bunks"),
        new Exit("Explore: Guts", "enter the guts",
        "<subject> open<s> the door and step<s> through a narrow hatchway"), new Exit(
        "Explore: EngineRoom", "enter the engine room",
        ...
        "the cargo bay through a huge {entrance|door}")], descriptionPage:
        "CorridorLeftJunction.description", coordinates: [-5, -45, 0]);
  }
  ...
  void setupBunks() {
    ...
    // ROOM
    new Room(zil, "Explore: Bunks", "bunks", [new Exit(
        "Explore: CorridorLeftNextToBunks", "exit to Corridor Left",
        "<subject> {{exit|leave}<s>|step<s> out} to Corridor Left"), new Exit(
        "Explore: CorridorRightNextToBunks", "exit to Corridor Right",
        "<subject> {{exit|leave}<s>|step<s> out} to Corridor Right")], descriptionPage:
        "Bunks.description", coordinates: [0, -25, 0], items: [shabuVials], actions:
        [siftThrough]);
  }
  ...
  void setupCorridorLeftNextToBunks() {
    new Room(zil, "Explore: CorridorLeftNextToBunks", "corridor left",
        ...
        "<subject> step<s> inside the {living quarters|bunks}"), new Exit(
        "Explore: CorridorLeftJunction",
        "walk {toward the cargo bay|to the {aft|back} of the ship}",
        "after walking for 3 minutes, <subject> arrive<s> at the left " "junction",
        cost: 2)], descriptionPage: "CorridorLeftNextToBunks.description", coordinates:
        [-5, -25, 0]);
  }

  void setupStaffRoom() {
    // ITEMS
    banana = new Item(zil, "banana", actions: [new Action("eat the banana", () {
    ...
    // ROOM
    new Room(zil, "Explore: StaffRoom", "staff room", [new Exit(
        "Explore: MedicalBay", "go through the little door",
        "<subject> squeeze<s> through a narrow, white passage and "
        "<subject> enter<s> the medbay through another small door"), new Exit(
        "Explore: CorridorLeftNextToAirlock", "exit to Corridor Left",
        "<subject> walk<s> out of the room into Corridor Left")], descriptionPage:
        "StaffRoom.description", coordinates: [-5, -15, 0], items: [banana], actions:
  ...
  void setupCorridorLeftNextToAirlock() {
    infoFlyer = new Item(zil, "info flyer", takeDescription:
        "<subject> take<s> <object>, fold<s> <objectPronoun> "
        "and put<s> <objectPronoun> in a pocket", actions: [new Action(
        "look at info flyer", () {
        echo("You pull the flyer out of your pocket and unfold it. "
            "\n\n[IMG]\n\nThen you fold it again and put " "it back.");
      }, needsToBeCarried: true, submenu: INVENTORY)], isActive: false);
    ...
    new Room(zil, "Explore: CorridorLeftNextToAirlock", "Corridor Left",
        [new Exit("Explore: CorridorLeftNextToCaptainsCabin", "walk towards the bridge",
        "<subject> walk<s> towards the bridge up to the point where there "
        "is the door to the captain's cabin on the left hand side"), new Exit(
        "Explore: StaffRoom", "enter the staff room",
        "<subject> enter<s> the staff room"), new Exit(
        "Explore: CorridorLeftNextToBunks",
        "walk {toward the cargo bay|to the {aft|back} of the ship}",
        "<subject> arrive<s> at the door to the sleeping quarters")], descriptionPage:
        "CorridorLeftNextToAirlock.description", coordinates: [-10, -15, 0], items:
        [infoFlyer], actions: [new Action.Goto("examine the airlock",
        "LeftAirlock.Look", onlyOnce: true)]);
  }
  ...
  void setupCaptainsCabin() {
    // ITEMS
    captainsGun = new Item(zil, "captain's gun", actions: [new Action(
        "check the gun", () => storyline.add(
        "You pull the gun out of your pocket and heft "
        "it in your hand. It's heavy, well-built and seems in fine "
        "condition. It is loaded."), needsToBeCarried: true, onlyOnce: true, submenu:
        INVENTORY), new Action("shoot the Gorilla", () {
        ...
        choice("Put the gun down", script: () {
          ...
          needsToBeCarried: true, submenu: INVENTORY)], takeDescription:
          "<subject> lift<s> the <object> and put<s> it in the " "pocket", isActive: false
          );
    gorillaCorpse = new Item(zil, "Gorilla's body", takeable: true, isActive:
        false);

    // ACTIONS
    firstLookAround = new Action.Goto("have a look around [~15 minutes]",
        "CaptainsCabinLookAround", onlyOnce: true);
    ...
    thirdLookAround = new Action.Goto(
        "search the rest of the room [~5 minutes]", "CaptainsCabinLookAroundTheRest",
    ...
    // ROOM
    new Room(zil, "Explore: CaptainsCabin", "captain's cabin", [new Exit(
        "Explore: CorridorLeftNextToCaptainsCabin", "exit the room",
        "<subject> leave<s> into the corridor")], descriptionPage:
        "CaptainsCabin.description", coordinates: [-10, -10, 0], items: [captainsGun],
        actions: [firstLookAround, secondLookAround, thirdLookAround,
  ...
  void setupCorridorLeftNextToCaptainsCabin() {
    new Room(zil, "Explore: CorridorLeftNextToCaptainsCabin", "Corridor Left",
        [new Exit("Explore: Bridge", "walk to the bridge",
        "<subject> {enter<s>|arrive<s> at} the bridge"), new Exit(
        "Explore: CaptainsCabin", "enter Captain's cabin",
        "<subject> open<s> the door to the Captain's cabin and " "enter<s>"), new Exit(
        "Explore: CorridorLeftNextToAirlock",
        "walk {toward the cargo bay|to the {aft|back} of the ship}",
        "<subject> {stride|walk}<s> towards the {{aft|back} of the " "ship|cargo bay}"
        )], descriptionPage: "CorridorLeftNextToCaptainsCabin.description", coordinates:
        [-5, -10, 0]);
  }
  ...
  void setupBridge() {
    ...
    "the bridge", [new Exit("Explore: Nose",
        ...
        "entrance to the captain's cabin"), new Exit(
        "Explore: CorridorRightNextToComputerRoom", "leave to Corridor Right",
        "<subject> {go<es>|walk<s>} through the sliding door into "
        "Corridor Right and – after a few more paces – arrive<s> at the "
        "entrance to the computer room")], descriptionPage: "Bridge.description",
        coordinates: [0, 0, 0], actors: [gorilla], actions: [waitForJumpToUnity,
  ...
  void setupNose() {
    ...
    // ROOM
    new Room(zil, "Explore: Nose", "nose of the ship", [new Exit(
        "Explore: Bridge", "crawl back to the bridge",
        "<subject> crawl<s> out of the nose hatchway onto the bridge")],
        descriptionPage: "Nose.description", coordinates: [0, 5, 0], actions:
        [scannerLook, scannerRepair]);
  }
  ...
  /// This is a simplified version of [createExtraEffortChoiceList] which 
  /// should cover most needs of [BodegaZil].
  void createExtraEffortChoiceListSimple(String noTryChoiceString,
      String noTryEcho,
      int noTryTime, bool skilled,
      String energyFreeTryChoiceString, num baseProbability,
      String energyConsumingTryChoiceString, num improvedProbability,
      int physicalPointsRequired, int mentalPointsRequired,
      String onSuccessEcho, int onSuccessTime,
      String onFailureEcho, int onFailureTime) {
    createExtraEffortChoiceList(
        noTryChoiceString,
        () {
          zil.update(computeTimeRequired(noTryTime, skilled), 
              describe: false, interactive: false);
          echo(noTryEcho);
        },
        [
          new ExtraEffortOption(energyFreeTryChoiceString, baseProbability, 
              0, 0, null, null),
          new ExtraEffortOption(energyConsumingTryChoiceString, 
              improvedProbability, 
              physicalPointsRequired, mentalPointsRequired, null, null),
        ],
        defaultOnSuccess: () {
          zil.update(computeTimeRequired(onSuccessTime, skilled), 
              describe: false, interactive: false);
          echo(onSuccessEcho);
        },
        defaultOnFailure: () {
          zil.update(computeTimeRequired(onFailureTime, skilled), 
              describe: false, interactive: false);
          echo(onFailureEcho);
        }
    );
  ...
  /**
   * Creates choices for a "bypass" and an arbitrary number of extra effort
   * options. [noTryChoiceString] and [onNoTry] will create an [EgbChoice]
   * which allows the player to not try at all (to avoid failure). The
   * [options] iterable provides a way to define any number of different
   * choices, from "try your luck" to "exert every effort".
   * 
  ...
  void createExtraEffortChoiceList(
      ...
      Iterable<ExtraEffortOption> options, 
      {Function defaultOnSuccess, Function defaultOnFailure}) {
    choice(noTryChoiceString, script: onNoTry);
    
    for (ExtraEffortOption option in options) {
      ...
      String probability = Randomly.humanStringifyProbability(
          option.probability);
      choiceString.write(" [$probability]");

      void runIfNotNull(Function f, Function backup) {
        if (f != null) {
          f();
        } else if (backup != null) {
          backup();
      ...
      choice(choiceString.toString(), script: () {
        physicalPoints.value -= option.physicalPointsRequired;
        mentalPoints.value -= option.mentalPointsRequired;
        if (Randomly.saveAgainst(option.probability)) {
          // Success
          runIfNotNull(option.onSuccess, defaultOnSuccess);
        } else {
          // Failure
          runIfNotNull(option.onFailure, defaultOnFailure);
        }
      }); // TODO: add disabled: true for options with too high cost
    }
  }
...
const List tirednessStrings = const ["quite tired", "really tired",
    "extremely tired", "exhausted", "absolutely exhausted"];

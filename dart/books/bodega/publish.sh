...
$DIR/copy_from_drive.sh && /Applications/dart/dart-sdk/bin/dart $DIR/../../bin/build.dart $DIR/bodega.egb && \
  ...
  rsync -avL --chmod=o+r -e "ssh -p 2222 -o PubkeyAuthentication=no" $DIR/bodega.dart.js* $DIR/bodega.html.dart.js* $DIR/index.html $DIR/stylesheets $DIR/img filiph@visible.cz:public_html/egamebook.com/test/

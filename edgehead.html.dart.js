...
while(true)switch(z){case 0:x=new B.e_(!1)
w=document
...
r=H.l([],[G.jY])
z=2
return P.ae(M.bQ("edgehead.isolate.dart",new G.ie(null,null,null,null,null,null,1,new P.ac(""),new B.e_(!1),null,null,w,null,r,null,null,new H.J(0,null,null,null,null,null,0,[null,null]),null,null,null),new G.jU()),$async$ds)

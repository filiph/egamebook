...
abstract class FightSituation extends Situation
  ...
  List<ActionBuilder> get actionGenerators => [
        ...
        startThrustSpearDownPlayerBuilder,
  ...
  Actor getActorAtTime(int time, Simulation sim, WorldState world) {
    ...
    for (var actor in actors) {
      ...
      DateTime latestProactiveTime = latestProactiveRecord?.time ?? pastInfinity;
      ...
      DateTime latestAnyTime = latestAnyRecord?.time ?? pastInfinity;

...
class _$EdgeheadGlobalState extends EdgeheadGlobalState {
  ...
  _$EdgeheadGlobalState._({this.isInTesterMode}) : super._() {
    if (isInTesterMode == null) {
      throw new BuiltValueNullFieldError(
          'EdgeheadGlobalState', 'isInTesterMode');
    }
  }
...
class EdgeheadGlobalStateBuilder
  ...
  EdgeheadGlobalStateBuilder get _$this {
    if (_$v != null) {
      _isInTesterMode = _$v.isInTesterMode;
      _$v = null;
    }
    return this;
  }
  ...
  _$EdgeheadGlobalState build() {
    final _$result =
        _$v ?? new _$EdgeheadGlobalState._(isInTesterMode: isInTesterMode);
    replace(_$result);
    return _$result;
  }
}

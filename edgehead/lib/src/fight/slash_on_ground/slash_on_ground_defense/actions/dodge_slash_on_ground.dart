...
class DodgeSlashOnGround extends OtherActorAction {
  static final DodgeSlashOnGround singleton = DodgeSlashOnGround();

  static const String className = "DodgeSlashOnGround";
  ...
  String applyFailure(ActionContext context, Actor enemy) {
    ...
    return "${a.name} fails to dodge ${enemy.name}'s slash on ground";
  }
  ...
  ReasonedSuccessChance getSuccessChance(
    ...
    return situation.predeterminedChance
        .or(computeDodgeSlashOnGround(a, sim, w, enemy));
  }

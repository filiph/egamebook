...
ReasonedSuccessChance computeShieldBlockSlashOnGround(
...
class ShieldBlockSlashOnGround extends OtherActorAction {
  static final ShieldBlockSlashOnGround singleton = ShieldBlockSlashOnGround();

  static const String className = "ShieldBlockSlashOnGround";
  ...
  String applyFailure(ActionContext context, Actor enemy) {
    ...
    a.report(
        s,
        "<subject> tr<ies> to {block|stop|deflect} the {slash|attack|strike} "
        "with <object2>",
  ...
  String applySuccess(ActionContext context, Actor enemy) {
    ...
    a.report(
        s,
        "<subject> {block<s>|stop<s>|deflect<s>} the {slash|attack|strike} "
        "with <object2>",
        object2: a.currentShield,
        positive: true);
  ...
  ReasonedSuccessChance getSuccessChance(
    ...
    return situation.predeterminedChance
        .or(computeShieldBlockSlashOnGround(a, sim, w, enemy));
  }

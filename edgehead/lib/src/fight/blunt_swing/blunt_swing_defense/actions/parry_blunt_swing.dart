...
class ParryBluntSwing extends OtherActorAction {
  static final ParryBluntSwing singleton = ParryBluntSwing();

  static const String className = "ParryBluntSwing";

  @override
  final String helpMessage = "Parrying means deflecting the opponent's move "
  ...
  ReasonedSuccessChance getSuccessChance(
    ...
    return situation.predeterminedChance
        .or(computeParryBluntSwing(a, sim, w, enemy));
  }
